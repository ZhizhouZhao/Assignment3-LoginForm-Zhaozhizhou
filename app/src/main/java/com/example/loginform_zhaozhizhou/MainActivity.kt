package com.example.loginform_zhaozhizhou
...
import com.example.loginform_zhaozhizhou.ui.theme.LoginFormZhaozhizhouTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            LoginFormZhaozhizhouTheme {
...
fun LoginForm() {
    ...
    val ownName = "c3zhzh00@students.oamk.fi"
    val ownKey = "123456"
